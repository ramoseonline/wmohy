          ...
          <div className="grid w-full gap-8 md:grid-cols-2">
            ...
            <div className="order-1 md:order-2 hidden md:flex items-center justify-center">
              <div className="rounded-2xl bg-primary p-10 text-primary-foreground shadow-xl">
                <img src="https://cdn.builder.io/api/v1/image/assets%2Fed401c9a1ea24dc9b78123cf1ccb99a0%2Fd105d53fc52f4907b02a9b7b2caadfa4?format=webp&width=800" alt="شعار WMOHY" className="h-14 mb-6" />
